...
waypoints = [(1, 0), (1.2, 0), (1.3, -0.01), (1.5, 0), (2, 0),( 2.5, 0), (3, 0), (3.1,-0.1), (3.2,-0.2), (3.5, -0.5), (3.5,-1), (4, -1), (7, -1)]  # Waypoints a los que el robot se debe mover
...
def navigate():
    ...
    while not rospy.is_shutdown():
        ...
        if distance < 0.1:  # Umbral de cercanía para considerar que hemos llegado al waypoint
